...
function createConverter(uriConverter) {
    ...
    function asDocumentSymbol(value) {
        let result = new code.DocumentSymbol(value.name, value.detail !== void 0 ? value.detail : value.name, asSymbolKind(value.kind), asRange(value.range), asRange(value.selectionRange));
